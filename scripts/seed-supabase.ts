...
const projects = [
  ...
  },
  {
    ...
    title_zh: "Momentum",
    title_ja: "Momentum",
    description_fr: "Plateforme de quiz interactifs en temps réel avec classement instantané. Idéale pour cours, événements et team-building.",
    description_en: "Real-time interactive quiz platform with instant leaderboard. Ideal for classes, events and team-building.",
    description_zh: "实时互动问答平台，即时排行榜。适用于课程、活动和团队建设。",
    description_ja: "リアルタイムインタラクティブクイズプラットフォーム。即時ランキング表示。授業、イベント、チームビルディングに最適。",
    tags: ['React', 'Real-time', 'Quiz', 'Education'],
    live_url: 'https://momentum.artist-dev.com/',
    image_url: '/assets/projets/momentum-demo.gif',
    sort_order: 5,
    is_featured: true,
  },
  {
    slug: 'les-chats-sont-mignons',
    title_fr: "Les chats sont mignons",
    title_en: "Les chats sont mignons",
    title_zh: "Les chats sont mignons",
    title_ja: "Les chats sont mignons",
    description_fr: "Projet pédagogique HTML/CSS pour étudiants L1 : structure sémantique, Grid, animations et responsive design.",
    description_en: "Educational HTML/CSS project for L1 students: semantic structure, Grid, animations and responsive design.",
    description_zh: "面向L1学生的HTML/CSS教学项目：语义结构、Grid布局、动画和响应式设计。",
    description_ja: "L1学生向けHTML/CSS教育プロジェクト：セマンティック構造、Grid、アニメーション、レスポンシブデザイン。",
    tags: ['HTML', 'CSS', 'Pedagogy', 'Responsive'],
    github_url: 'https://github.com/Maximus203/Les-chats-sont-mignons',
    image_url: '/assets/projets/les-chats-sont-mignons.png',
    sort_order: 6,
    is_featured: true,
  },
];
