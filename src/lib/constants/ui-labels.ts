...
export const UI_LABELS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    toolConverterWeightSaved: 'Poids économisé',
    toolConverterWeightIncreased: 'Poids augmenté',
    toolConverterWeightSavedTooltip: 'Poids économisé par rapport à l\'original',
    toolConverterWeightIncreasedTooltip: 'Poids augmenté par rapport à l\'original',
    launch: 'Lancer',
  ...
  en: {
    ...
    toolConverterWeightSaved: 'Weight saved',
    toolConverterWeightIncreased: 'Weight increased',
    toolConverterWeightSavedTooltip: 'Weight saved compared to original',
    toolConverterWeightIncreasedTooltip: 'Weight increased compared to original',
    launch: 'Launch',
  ...
  zh: {
    ...
    toolConverterWeightSaved: '节省的空间',
    toolConverterWeightIncreased: '空间增加',
    toolConverterWeightSavedTooltip: '与原图相比节省的空间',
    toolConverterWeightIncreasedTooltip: '与原图相比增加的空间',
    launch: '启动',
  ...
  ja: {
    ...
    toolConverterWeightSaved: '節約した容量',
    toolConverterWeightIncreased: '容量増加',
    toolConverterWeightSavedTooltip: '元の画像と比較して節約した容量',
    toolConverterWeightIncreasedTooltip: '元の画像と比較して増加した容量',
    launch: '起動',
