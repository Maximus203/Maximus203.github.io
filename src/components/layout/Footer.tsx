...
import { Github, Heart, Instagram, Linkedin, Mail, Rocket, Youtube } from 'lucide-react';
...
const Footer: React.FC<FooterProps> = ({ data, labels, lang }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href={`/${lang}/#skills`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
                  {labels.skills}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/#projects`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
                  {labels.projects}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/#about`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
                  {labels.about}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/gallery/`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
                  {labels.gallery}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href={`/${lang}/tools/readme-generator/`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
                  {labels.toolReadme}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/tools/meme-generator/`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
                  {labels.toolMeme}
                </Link>
              </li>
              <li>
                <Link href={`/${lang}/tools/image-converter/`} className="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 text-sm transition-colors">
