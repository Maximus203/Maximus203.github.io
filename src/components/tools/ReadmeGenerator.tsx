...
`;
  ...
  const generateMarkdown = () => {
    ...
    if (selectedSkills.length > 0) {
        md += `  <!-- STACK TECHNIQUE -->\n`;
        md += `  <h3 style="font-family: 'Fira Code', monospace;">\u{1F6E0} Mon arsenal technique</h3>\n`;
      ...
      <div className="bg-white dark:bg-[#0d1117] border border-gray-200 dark:border-gray-800 rounded-2xl p-8 mb-8 shadow-sm">
         ...
         >
             ...
             <div className={`flex flex-wrap gap-2 ${formData.alignment === 'center' ? 'justify-center' : formData.alignment === 'right' ? 'justify-end' : 'justify-start'}`}>
                 ...
                 {formData.cvUrl && <img src="https://img.shields.io/badge/CV-T%C3%A9l%C3%A9charger-E34F26?style=for-the-badge&logo=adobe-acrobat-reader&logoColor=white" alt="CV" />}
             </div>
             ...
             {formData.about && (
                <p className="text-gray-700 dark:text-gray-300 max-w-2xl leading-relaxed">{'\u{1F52D}'} {formData.about}</p>
             )}

             {/* Trophies */}
             {formData.showTrophies && (
                 <div className="w-full">
                     <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{'\u{1F3C6}'} Trophies</h3>
             ...
             {selectedSkills.length > 0 && (
                <div className="space-y-4 w-full">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white font-mono">{'\u{1F6E0}'} Mon arsenal technique</h3>
                    <div className={`flex flex-wrap gap-2 ${formData.alignment === 'center' ? 'justify-center' : formData.alignment === 'right' ? 'justify-end' : 'justify-start'}`}>
            ...
            {activeTab === 'profile' && (
                <div className="space-y-6">
                    <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm space-y-4">
                        ...
                        <div>
                            <label className="block text-xs font-medium text-gray-500 uppercase mb-1">&Agrave; propos</label>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm space-y-4">
                        ...
                        <div>
                            <label className="block text-xs font-medium text-gray-500 uppercase mb-1">Texte Anim&eacute; (s&eacute;par&eacute; par ;)</label>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
                     ...
                     <div className="mb-6 bg-gray-50 dark:bg-slate-900 p-3 rounded-xl border border-gray-100 dark:border-slate-700">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                           ...
                           >
                              <LayoutGrid size={16} /> Ic&ocirc;nes
                           </button>
                        </div>
                     </div>
                 ...
                 <div className="space-y-6">
                     <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
                        <div className="flex items-center gap-2 mb-4 text-indigo-600 dark:text-indigo-400 font-bold">
                            <Palette size={18} /> Th&egrave;me & Style
                        </div>
                     ...
                     <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 cursor-pointer hover:border-indigo-300 transition-colors">
                                ...
                                <span className="text-sm font-medium">Afficher Statistiques G&eacute;n&eacute;rales</span>
                            </label>
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 cursor-pointer hover:border-indigo-300 transition-colors">
                                ...
                                <span className="text-sm font-medium">Afficher Streaks (Jours cons&eacute;cutifs)</span>
                            </label>
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 cursor-pointer hover:border-indigo-300 transition-colors">
                     ...
                     <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm">
                        <div className="flex items-center gap-2 mb-4 text-indigo-600 dark:text-indigo-400 font-bold">
                            <Layers size={18} /> Widgets Avanc&eacute;s
                        </div>
                        <div className="space-y-3">
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 cursor-pointer hover:border-indigo-300 transition-colors">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium">Troph&eacute;es GitHub</span>
                                </div>
                            </label>
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 cursor-pointer hover:border-indigo-300 transition-colors">
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 cursor-pointer hover:border-indigo-300 transition-colors">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium">Graphique d&apos;activit&eacute; Complet</span>
                                </div>
                            </label>
                            <label className="flex items-center gap-3 p-3 rounded-xl border border-green-100 dark:border-green-900/30 bg-green-50 dark:bg-green-900/10 cursor-pointer hover:border-green-300 transition-colors">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-0.5">N&eacute;cessite une GitHub Action (fournie &agrave; l&apos;&eacute;tape suivante)</p>
                                </div>
                            </label>
                        </div>
                     </div>
           ...
           <div className="bg-[#0d1117] rounded-3xl p-6 border border-gray-800 shadow-2xl relative overflow-hidden flex flex-col max-h-[85vh] min-h-[500px]">
              ...
              {outputTab === 'workflow' && (
                  <div className="mt-4 pt-4 border-t border-gray-800 text-xs text-gray-400 flex-shrink-0">
                      ...
                      1. Cr&eacute;ez un fichier <code>.github/workflows/snake.yml</code> dans votre repo.<br/>
