...
import { Activity, AlignCenter, AlignLeft, AlignRight, Check, Code, Copy, Eye, Layers, LayoutGrid, Palette, Settings, Tag, Terminal, Trophy, Type, User, Users } from 'lucide-react';
