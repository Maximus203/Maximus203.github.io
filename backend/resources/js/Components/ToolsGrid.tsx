...
import { ArrowRight, FileText, Github, Image, RefreshCw, Smile, Zap } from 'lucide-react';
...
const ToolsGrid: React.FC<ToolsGridProps> = ({ labels = {}, onLaunch }) => {
  const tools = [
    {
      id: 'readme',
      title: labels.toolReadme || 'Readme Generator',
      desc: labels.toolReadmeDesc || 'Générez des fichiers README professionnels',
    ...
    {
      id: 'meme',
      title: labels.toolMeme || 'Meme Generator',
      desc: labels.toolMemeDesc || 'Créez des memes personnalisés',
    ...
    {
      id: 'converter',
      title: labels.toolConverter || 'Image Converter',
      desc: labels.toolConverterDesc || 'Convertissez vos images',
      ...
      {tools.map((tool, index) => (
        ...
        >
          ...
          <div className="p-6 flex flex-col flex-grow">
            ...
            >
               {tool.actionIcon}
               <span>{labels.launch || 'Lancer'}</span>
