...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, index = 0 }) => {
  ...
  const title = typeof project.title === 'string' ? project.title : project.title.fr;
  const description = typeof project.description === 'string' ? project.description : project.description.fr;
      ...
      <div className="p-6 md:p-8 flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex gap-2">
             ...
             {project.demo_url && (
                 <a href={project.demo_url} target="_blank" rel="noopener noreferrer" className="p-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full transition-colors text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white">
